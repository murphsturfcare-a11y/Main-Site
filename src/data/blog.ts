...
export const blogPosts: Record<string, BlogPost> = {
  ...
  "artificial-turf-cleaning-palm-desert": {
    ...
    readingTime: "4 min read",
    content: `
      <p class="text-charcoal-light font-body leading-relaxed mb-4"><strong>For Palm Desert turf, start with dry debris removal, prompt pet-waste pickup, and a look at your heaviest-use areas. Rinse only where needed, follow your turf manufacturer's instructions, and control where the water goes. Returning odor, embedded grit, or a recurring puddle needs an assessment, not another cleaner.</strong></p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Ask where dust enters, how pets use the space, where water leaves, and who checks the property while you are away. Those answers shape the routine in Palm Desert, Indian Wells, Bermuda Dunes, La Quinta, Indio, and Coachella.</p>
      <h2 id="start-with-a-walk-through" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Start with a walk-through</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Walk the edges before the center. Check where decomposed granite meets turf, where a gate opens onto a walkway, and where dogs repeatedly stop. Photograph lifted seams, worn fibers, and depressions so you can compare the same spots later.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Sort what you found into three groups: surface material, material embedded in the fibers, and defects under or around the turf. Leaves and grit are maintenance. A separating seam or a low spot holding water may need an installer; cleaning is not the fix.</p>
      <h2 id="a-routine-based-on-actual-use" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">A routine based on actual use</h2>
      <ul class="list-disc pl-6 space-y-2 mb-5 text-charcoal-light font-body leading-relaxed"><li><strong>After pet use:</strong> remove solid waste promptly and treat the spot as the turf maker directs, not on the whole-yard schedule.</li><li><strong>On routine checks:</strong> collect leaves and litter, inspect pet zones, and check for grit along landscape borders. Use manufacturer-approved equipment.</li><li><strong>After a dusty or windy day:</strong> inspect before rinsing and pick up coarse debris first.</li><li><strong>When conditions change:</strong> reassess after new pets, guests, landscape work, or weeks with nobody onsite.</li></ul>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Set the interval from a short log of odor, debris, and standing water; a dog run needs more attention than a decorative strip.</p>
      <h2 id="plan-water-use-before-rinsing" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Plan water use before rinsing</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Confirm the area drains, clear debris first, and use a controlled nozzle, not a running hose. Stop if water pools or heads toward a sidewalk. Where turf meets a pool deck or shared walkway, decide where the water goes before applying any product.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">The City of Palm Desert names water conservation and water quality as priorities and recommends sweeping hard surfaces instead of hosing them. Use the same dry-first approach on turf, and check current water guidance before wet work: see <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="https://www.palmdesert.gov/community/landscaping-and-park-maintenance">Palm Desert's landscape guidance</a> and <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="https://www.cvwd.org/667/Water-Saving-Guidelines">CVWD's water-saving guidance</a>.</p>
      <h2 id="schedule-around-sun-and-access" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Schedule around sun and access</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Choose the work window from the forecast, surface conditions, access, and product directions. A clock time does not prove the surface is ready for pets or people. Follow the product's rinsing and reopening instructions.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">For a gated home in Indian Wells or a managed property in Bermuda Dunes, send gate arrangements and an onsite contact. For a seasonal home in La Quinta or Indio, name someone who can report returning odor.</p>
      <h2 id="when-professional-cleaning-helps" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">When professional cleaning helps</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Request an assessment when brushing leaves grit behind, fibers stay matted in traffic lanes, or a pet area smells again. Send the turf age, manufacturer if known, square footage, number of pets, products already used, and photos.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Ask the quote to separate debris removal, grooming, odor treatment, and any repair referral. A cleaner should explain product compatibility and the limits of the work. A green surface cannot show the condition of the backing or base.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Start at <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/locations/palm-desert">Palm Desert turf cleaning and nearby service areas</a>. For odor, read our <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/blog/pet-turf-odor-palm-desert">pet-area guide</a> first; for lingering water, read the <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/blog/desert-turf-dust-drainage-coachella-valley">dust and drainage guide</a>.</p>
      <h2 id="palm-desert-maintenance-questions" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Palm Desert maintenance questions</h2>
      <h3 class="text-xl font-bold font-heading text-charcoal mt-6 mb-3">Does desert turf need cleaning when it looks green?</h3>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Color is one observation. Check the infill, pet areas, landscape edges, seams, and drainage. Turf can look green while holding debris or smelling in one corner.</p>
      <h3 class="text-xl font-bold font-heading text-charcoal mt-6 mb-3">Is one cleaning schedule right for every nearby city?</h3>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">No. A shaded pet run in Indio and a rarely used courtyard in Coachella need different tasks. Set the schedule from the property's conditions and manufacturer guidance.</p>
    `,
  },
  ...
  "pet-turf-odor-palm-desert": {
    ...
    readingTime: "4 min read",
    content: `      <p class="text-charcoal-light font-body leading-relaxed mb-4"><strong>When pet odor keeps coming back, find the spots your dog uses, clear the waste, and watch how water leaves them before buying another product. Odor can sit in the infill, the backing, or the base underneath. Cleaning may help with accessible residue; it cannot correct a drainage or installation defect.</strong></p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Odor is not heat. Deodorizing a surface does nothing for how it feels underfoot. Keep the two decisions separate when you plan a dog area in Palm Desert, Indian Wells, Bermuda Dunes, La Quinta, Indio, or Coachella.</p>
      <h2 id="map-the-odor-before-you-clean" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Map the odor before you clean</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Note where the smell is strongest and when. By the gate, under patio furniture, along a wall, or across the lawn? Record whether it returns after pet use, after a rinse, or after the house sat closed.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Clear the waste and pull debris out of the perimeter. Then watch the water. If one spot stays wet while the turf around it drains, that is not a fragrance problem. Ask for an assessment of the base below it.</p>
      <h2 id="what-to-do-between-visits" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">What to do between visits</h2>
      <ul class="list-disc pl-6 space-y-2 mb-5 text-charcoal-light font-body leading-relaxed"><li><strong>Pick up solid waste promptly.</strong> Do not push it through the fibers or rinse it toward the street.</li><li><strong>Follow the turf maker's directions.</strong> If the paperwork is gone, ask the installer for the turf and infill.</li><li><strong>Rinse the spot, not the yard.</strong> Stop if water pools or leaves the area.</li><li><strong>Time the recurrence.</strong> How fast odor returns helps decide whether to change the schedule or review the installation.</li></ul>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Several dogs in one corner need a different plan from an occasionally used lawn.</p>
      <h2 id="questions-to-ask-about-odor-products" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Questions to ask about odor products</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Ask for the product name, its compatibility with your turf and infill, the directions, and when the area reopens. Professional grade, natural, and pet friendly are not instructions. Never mix household products or put pool chemicals on the lawn.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Cleaning, deodorizing, and disinfecting are different claims. EPA notes that a disinfectant's approved uses and required wet contact time are specified on its label. A claim approved for one surface does not establish performance on yours. See <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="https://www.epa.gov/pesticide-registration/selected-epa-registered-disinfectants">EPA's directions for registered disinfectants</a>.</p>
      <h2 id="keep-heat-and-cleanliness-separate" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Keep heat and cleanliness separate</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Plan pet access around surface conditions and available shade, not how clean the lawn looks.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">CPSC notes that sun-exposed plastic and rubber play surfaces can get hot enough to cause burns, even on days that do not feel hot. That argues for a separate surface check, not a temperature rating for your turf. See the <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="https://www.cpsc.gov/s3fs-public/3200.pdf">CPSC playground burn-awareness fact sheet</a>.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Tell the cleaner where the dogs will wait while the area is closed. Reopening follows the product directions, not how the turf looks.</p>
      <h2 id="when-an-assessment-is-the-next-step" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">When an assessment is the next step</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Ask for help when odor returns quickly after routine care, one zone stays wet, or the lawn's history is unknown. A useful assessment looks at pet concentration, trapped residue, infill condition, and drainage. Some yards need an installer too.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Send photos, your notes on when odor returns, and any products already used. Say what you want: a recurring plan, one problem corner, or a yard ready before a seasonal return. No cleaner can promise a dog area never smells again.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Request <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/locations/palm-desert">Palm Desert pet-area turf cleaning</a>, or see <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/locations/palm-desert/turf-cleaning-in-la-quinta">La Quinta</a> and <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/locations/palm-desert/turf-cleaning-in-indio">Indio</a>. For a shared dog area or pet business, use the <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/commercial-turf-cleaning/palm-desert">Palm Desert commercial page</a> and include the number of dogs and your closure windows.</p>
      <h2 id="pet-area-questions" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Pet-area questions</h2>
      <h3 class="text-xl font-bold font-heading text-charcoal mt-6 mb-3">Will a hose alone solve persistent odor?</h3>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Rinsing may help with routine residue when the turf drains properly. Recurring odor needs an assessment of the affected layers and usage pattern.</p>
      <h3 class="text-xl font-bold font-heading text-charcoal mt-6 mb-3">Does odor-free turf prove it has been disinfected?</h3>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">No. Smell cannot establish microbial performance. A disinfecting claim depends on the specific product, the intended surface, and the application directions.</p>
`,
  },
  ...
  "desert-turf-dust-drainage-coachella-valley": {
    ...
    readingTime: "4 min read",
    content: `
      <p class="text-charcoal-light font-body leading-relaxed mb-4"><strong>Clear loose debris before any wet work, then watch where water collects and how it drains. Cleaning addresses material in the fibers and accessible infill. Pooling that returns to the same low spot, lifting seams, or water arriving off hardscape needs an installation or drainage review.</strong></p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Grit and storm runoff can arrive together, so inspect after a wind or rain event. Conditions differ lot by lot across Palm Desert, Indian Wells, Bermuda Dunes, La Quinta, Indio, and Coachella; a neighbor's drainage does not predict yours.</p>
      ...
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Start where turf meets decomposed granite, gravel, planted beds, or paving. Check gates and raised planters for material washing in. Compare a protected corner with an exposed edge. A Bermuda Dunes yard edged with loose landscape material may need a different approach than an enclosed Indian Wells courtyard.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Do not treat every grain as dirt. Many turf systems hold intentional infill, so check the installation specifications before reaching for a vacuum, power broom, or aggressive blower. If the infill type is unknown, ask the installer before cleanup removes what the turf needs.</p>
      ...
      <ul class="list-disc pl-6 space-y-2 mb-5 text-charcoal-light font-body leading-relaxed">
        <li><strong>Wait for workable conditions.</strong> Skip high winds, lightning, floodwater, or unidentified contamination.</li>
        <li><strong>Collect coarse material first.</strong> Litter, branches, leaves, and pet waste come off before brushing.</li>
        <li><strong>Match the equipment.</strong> Follow the manufacturer's directions for brush type and settings, and protect seams.</li>
        <li><strong>Inspect again.</strong> Decide whether what remains is embedded debris, matted fiber, staining, or a defect.</li>
        <li><strong>Plan wet work last.</strong> Confirm the drainage route, approved product, and runoff control before adding water.</li>
      </ul>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Do not blow dust into a neighbor's yard or wash it into the street. If dry equipment puts visible dust in the air, change the method. Ask where collected debris goes.</p>
      ...
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Use what you can see after ordinary care or a storm. Note the location, rough extent, and how long water stands, then compare that spot with nearby turf. No drainage time can be read off a photograph.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Water across the whole surface is a different problem than one puddle by a downspout; runoff off a sloped patio is a third. Tell the provider whether it began after landscape work, a new border, or heavy traffic.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Skip repeated large-volume hose tests. CVWD's water-saving guidance addresses landscape runoff; read <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="https://www.cvwd.org/667/Water-Saving-Guidelines">the district's guidance</a> and your provider's rules before testing.</p>
      ...
      <ul class="list-disc pl-6 space-y-2 mb-5 text-charcoal-light font-body leading-relaxed">
        <li><strong>Ask a cleaner about:</strong> loose and embedded debris, grooming, pet residue, and whether accessible infill can be maintained.</li>
        <li><strong>Ask an installer or drainage specialist about:</strong> low spots, unstable edges, separated seams, damaged backing, wrong slope, or water entering from elsewhere.</li>
        <li><strong>Escalate unusual contamination:</strong> flooding that may involve sewage, fuel, or unidentified chemicals needs its own assessment first.</li>
      </ul>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Ask for cleaning and repair to be quoted separately. A quote that reads every puddle as dirty turf can miss the cause; a replacement quoted without inspecting the layers may be premature.</p>
      ...
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Send wide shots, close-ups of the affected area, a view of the nearby landscape or drain, the turf age if known, and manufacturer details. On a managed property, name who can authorize a repair referral if cleaning uncovers a defect.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Murphy's Turf can review cleaning needs through the <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/locations/palm-desert">Palm Desert service-area page</a>, with local pages for <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/locations/palm-desert/turf-cleaning-in-bermuda-dunes">Bermuda Dunes</a>, <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/locations/palm-desert/turf-cleaning-in-indian-wells">Indian Wells</a>, and <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/locations/palm-desert/turf-cleaning-in-coachella">Coachella</a>. For checks between visits, use our <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/blog/artificial-turf-cleaning-palm-desert">desert maintenance plan</a>.</p>
      ...
      <p class="text-charcoal-light font-body leading-relaxed mb-4">It can help maintain compatible fibers and infill, but it does not build or repair a slope, base, or drainage outlet. Persistent pooling needs its cause checked.</p>
      <h3 class="text-xl font-bold font-heading text-charcoal mt-6 mb-3">Should all sand be removed from artificial turf?</h3>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">No. Sand may be intentional infill. Identify the turf system first, then follow its manufacturer requirements.</p>
    `,
  },
  ...
  "seasonal-home-commercial-turf-palm-desert": {
    ...
    readingTime: "4 min read",
    content: `
      <p class="text-charcoal-light font-body leading-relaxed mb-4"><strong>A managed-property turf plan needs a named inspector, tasks matched to actual use, a workable closure window, and a record of what needs follow-up. A recurring appointment alone does not cover waste pickup, storm checks, or damage nobody sees.</strong></p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">A seasonal Palm Desert home can go weeks unchecked. A La Quinta rental can turn over on short notice. A shared amenity in Indio, Coachella, or Bermuda Dunes splits access, landscaping, and cleaning among several people. Write the handoffs down first.</p>
      <h2 id="build-a-zone-by-zone-property-sheet" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Build a zone-by-zone property sheet</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Divide the turf by function: decorative frontage, pet area, putting surface, poolside strip, event space, walkway. Record each zone's size, turf product if known, drainage arrangement, and responsible person.</p>
      <ul class="list-disc pl-6 space-y-2 mb-5 text-charcoal-light font-body leading-relaxed"><li><strong>Owner or manager:</strong> sets scope, approves repairs, receives reports.</li><li><strong>Caretaker or onsite staff:</strong> flags waste, debris, odor, and damage.</li><li><strong>Cleaning provider:</strong> performs the agreed work and reports what it finds.</li><li><strong>Installer:</strong> reviews drainage, seam, and base problems cleaning cannot fix.</li></ul>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Keep the manufacturer's care directions and installer contacts with the sheet, and share access details privately. Those roles are suggestions, not legal duties; check your governing documents for who authorizes work.</p>
      <h2 id="before-leaving-a-seasonal-home" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Before leaving a seasonal home</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Walk the yard with the caretaker, or send dated photos marking the problem areas. Arrange waste removal, debris checks, and a contact process for storms or damage. Record which products have been used so nobody starts an incompatible treatment.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Set reporting triggers instead of an instruction to keep the lawn nice: a lifting seam, a new puddle, odor, gravel over a border. Before you return, ask for fresh photos and leave time for inspection and follow-up.</p>
      <h2 id="fit-cleaning-around-guests-and-residents" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Fit cleaning around guests and residents</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">For hospitality properties and shared amenities, work out the real closure window: setup, service, any specified rinse time, and reopening checks. Do not post a reopening time before the provider has seen the property. Closed pet areas need an alternative.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">For disinfecting work, ask for the product name, intended use, and label directions. EPA separates cleaning from sanitizing and disinfecting, and a tidy surface does not prove all three. Read <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="https://www.epa.gov/coronavirus-and-disinfectants/whats-difference-between-products-disinfect-sanitize-and-clean">EPA's explanation of these actions</a> before writing the scope.</p>
      <h2 id="choose-an-interval-from-observations" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Choose an interval from observations</h2>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Start from workload: dogs using one corner, guests crossing a narrow entry, or long stretches with no activity. Set a first review point, then adjust from what visits document. A decorative frontage and a shared pet run do not need the same tasks.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Add checks after heavy use, dusty weather, landscape work, or a drainage complaint. Record the date, zones serviced, observations, products applied, and open items. Use the same photo angles each time.</p>
      <h2 id="compare-quotes-on-the-same-scope" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Compare quotes on the same scope</h2>
      <ul class="list-disc pl-6 space-y-2 mb-5 text-charcoal-light font-body leading-relaxed"><li>Which zones and areas are included?</li><li>Does the price cover debris collection, grooming, and odor work?</li><li>How will the provider confirm turf and infill compatibility?</li><li>Who supplies water access and keeps runoff off adjacent areas?</li><li>What triggers a separate repair assessment or extra authorization?</li><li>What are the closure, reopening, and reporting arrangements?</li></ul>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Ask for current insurance and any credential the work requires. Compare exclusions and access assumptions as closely as the price. Cleaning does not correct drainage, seams, or the base.</p>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Request <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/commercial-turf-cleaning/palm-desert">commercial turf cleaning in Palm Desert</a>, or review <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/commercial-turf-cleaning/palm-desert/commercial-turf-cleaning-in-la-quinta">La Quinta managed properties</a> and <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/commercial-turf-cleaning/palm-desert/commercial-turf-cleaning-in-indian-wells">Indian Wells businesses and common areas</a>. For a single seasonal residence, start with <a class="text-forest underline underline-offset-2 hover:text-forest-dark" href="/locations/palm-desert">residential Palm Desert service</a>. Send the property sheet, zone photos, and access window.</p>
      <h2 id="managed-property-questions" class="text-2xl font-bold font-heading text-charcoal mt-8 mb-4 scroll-mt-36">Managed-property questions</h2>
      <h3 class="text-xl font-bold font-heading text-charcoal mt-6 mb-3">Does an unused seasonal home still need checks?</h3>
      <p class="text-charcoal-light font-body leading-relaxed mb-4">Yes. No foot traffic does not mean no debris, leak, animal waste, or damage. Assign someone to inspect and report while the owner is away.</p>
      ...
      <p class="text-charcoal-light font-body leading-relaxed mb-4">No. A cleaning visit documents the agreed work. Property-specific obligations and required inspections stay with the responsible manager and its advisers.</p>
    `,
  },
};
