...
export const regionalCare: Record<string, RegionalCare> = {
  ...
  'palm-desert': {
    ...
    challenges: [
      ...
      { title: 'Gated access and seasonal timing', description: 'For a country club or association property, arrange vendor authorization, the approved entrance, and a local contact before the appointment, since access rules vary by community. For a seasonal home or rental, give the return date so the work and reopening instructions fit before anyone arrives.' },
    ],
