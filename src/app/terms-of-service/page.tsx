...
export const metadata: Metadata = {
  ...
  description:
    "Murphy's Turf Care terms of service. Review the terms and conditions governing your use of our lawn care and turf cleaning services in California.",
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10">
            <p className="text-charcoal font-body text-base leading-relaxed mb-4">
              Welcome to Murphy&apos;s Turf Care LLC (&quot;Murphy&apos;s Turf Care,&quot; &quot;Company,&quot;
              &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). These Terms of Service
              (&quot;Terms&quot;) govern your access to and use of our website, services, and any
              related offerings provided by Murphy&apos;s Turf Care LLC, a California limited liability
            ...
            <p className="text-charcoal font-body text-base leading-relaxed">
              ...
              engaging with Murphy&apos;s Turf Care LLC, you acknowledge that you have read, understood,
          ...
          <div className="space-y-12">
            ...
            <div id="acceptance">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                By using the Murphy&apos;s Turf Care LLC website or engaging our services in any capacity,
                ...
                features offered by Murphy&apos;s Turf Care LLC.
              </p>
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                These Terms constitute a legally binding agreement between you and Murphy&apos;s Turf Care
            ...
            <div id="services-description">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                Murphy&apos;s Turf Care LLC provides professional lawn care and turf cleaning services
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                ...
                agreement. Murphy&apos;s Turf Care LLC reserves the right to modify, expand, or discontinue
              ...
              <p className="text-charcoal font-body text-base leading-relaxed">
                ...
                demand. Murphy&apos;s Turf Care LLC does not guarantee the availability of any particular
            ...
            <div id="service-agreements">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                All services provided by Murphy&apos;s Turf Care LLC are subject to a service agreement or
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                Murphy&apos;s Turf Care LLC will work with you to schedule services at mutually convenient
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                ...
                cancellation provisions set forth in Section 5. Murphy&apos;s Turf Care LLC reserves the
            ...
            <div id="pricing-payment">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                All quotes and estimates provided by Murphy&apos;s Turf Care LLC are valid for a period of
                ...
                Murphy&apos;s Turf Care LLC will communicate any price adjustments to you before proceeding
                with the service.
              </p>
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                ...
                permitted by California law, whichever is less. Murphy&apos;s Turf Care LLC reserves the
              ...
              <p className="text-charcoal font-body text-base leading-relaxed">
                Murphy&apos;s Turf Care LLC reserves the right to adjust its pricing at any time. For
            ...
            <div id="cancellation">
              ...
              <h3 className="text-lg font-semibold font-heading text-charcoal mb-2">
                Cancellation by Murphy&apos;s Turf Care LLC
              </h3>
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                Murphy&apos;s Turf Care LLC reserves the right to cancel or refuse service at its
                ...
                with these Terms. In the event Murphy&apos;s Turf Care LLC cancels a service, you will not
              ...
              <p className="text-charcoal font-body text-base leading-relaxed">
                ...
                communicated in advance, a service trip fee may apply. Murphy&apos;s Turf Care LLC will
            ...
            <div id="property-access">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                By scheduling services with Murphy&apos;s Turf Care LLC, you grant us permission to access
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                You are responsible for notifying Murphy&apos;s Turf Care LLC of any pre-existing
                ...
                uneven terrain, or areas prone to flooding. Murphy&apos;s Turf Care LLC shall not be held
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                Murphy&apos;s Turf Care LLC carries comprehensive general liability insurance. If our crew
                ...
                reported to Murphy&apos;s Turf Care LLC in writing within seven (7) business days of the
              ...
              <p className="text-charcoal font-body text-base leading-relaxed">
                Murphy&apos;s Turf Care LLC maintains workers&apos; compensation insurance for all
                employees. You agree not to hold Murphy&apos;s Turf Care LLC liable for any personal
            ...
            <div id="warranties">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-6">
                Murphy&apos;s Turf Care LLC stands behind the quality of our work. If you are not satisfied
              ...
              <p className="text-charcoal font-body text-base leading-relaxed">
                ...
                and Murphy&apos;s Turf Care LLC makes no warranties, express or implied, including but not
                ...
                availability, sun exposure, and existing lawn health. Murphy&apos;s Turf Care LLC does not
            ...
            <div id="limitation-liability">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                To the maximum extent permitted by applicable law, Murphy&apos;s Turf Care LLC, including
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                In no event shall the total aggregate liability of Murphy&apos;s Turf Care LLC for all
                claims arising out of or related to a specific service exceed the total amount paid by
                you to Murphy&apos;s Turf Care LLC for that particular service. This limitation applies to
            ...
            <div id="indemnification">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                You agree to indemnify, defend, and hold harmless Murphy&apos;s Turf Care LLC and its
            ...
            <div id="force-majeure">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                Murphy&apos;s Turf Care LLC shall not be liable for any failure or delay in performing its
              ...
              <p className="text-charcoal font-body text-base leading-relaxed">
                In the event of a force majeure occurrence, Murphy&apos;s Turf Care LLC will make
            ...
            <div id="governing-law">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                ...
                services provided by Murphy&apos;s Turf Care LLC shall be governed by and construed in
            ...
            <div id="dispute-resolution">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                Murphy&apos;s Turf Care LLC values its customers and is committed to resolving disputes
            ...
            <div id="changes">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                Murphy&apos;s Turf Care LLC reserves the right to update, modify, or replace these Terms of
            ...
            <div id="contact">
              ...
              <p className="text-charcoal font-body text-base leading-relaxed mb-4">
                ...
                the services provided by Murphy&apos;s Turf Care LLC, please do not hesitate to contact
                us:
              </p>
