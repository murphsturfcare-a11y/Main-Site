          ...
          <div className="space-y-12">
            ...
            <div id="information-we-collect">
              ...
              <ul className="list-disc list-inside text-charcoal font-body text-base leading-relaxed mb-6 space-y-1 pl-4">
                ...
                <li>Details about your property and lawn care needs</li>
            ...
            <div id="how-we-use">
              ...
              <ul className="list-disc list-inside text-charcoal font-body text-base leading-relaxed mb-6 space-y-1 pl-4">
                ...
                <li>To provide quotes and estimates for lawn care and turf cleaning services</li>
              ...
              <ul className="list-disc list-inside text-charcoal font-body text-base leading-relaxed mb-6 space-y-1 pl-4">
                ...
                <li>To provide you with seasonal lawn care tips and promotional offers (with your consent)</li>
