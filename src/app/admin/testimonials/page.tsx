...
const initialTestimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 4,
    text: "Great mowing and edging service. They keep our large property looking sharp every week. Only reason for four stars is scheduling can occasionally shift due to weather, but that's understandable in California. Overall very reliable crew.",
    date: "2026-01-22",
    published: true,
    featured: false,
  },
  ...
  },
  {
    ...
    location: "Menifee, CA",
    rating: 5,
    text: "We just moved into a new build with bare dirt for a yard. Murphy's Turf Care handled the entire sod installation from grading to laying the turf. They even set up a watering schedule for us to follow. Six months later and it looks like it's been established for years. Exceptional work from start to finish.",
    date: "2025-12-15",
    published: true,
    featured: false,
  },
  ...
  },
  {
    ...
    rating: 4,
    text: "Had them do a full spring cleanup — dethatching, aeration, and a first round of fertilizer. The yard bounced back faster than any year prior. Good communication and reasonable rates.",
    date: "2025-10-20",
    published: true,
    featured: false,
  },
