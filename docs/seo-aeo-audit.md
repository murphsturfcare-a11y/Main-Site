...
**Phone:** the area launched on the shared Southern California number 951-331-3300; on September 13, 2026 the business confirmed the dedicated Palm Desert number **925-588-6546**. It is read from the Palm Desert region data, so it appears on the Palm Desert pages, the regional call picker and the site-wide LocalBusiness contact points. Quote forms send the `palm-desert` region with the page city; the lead function turns that into the `location-palm-desert` CRM tag.
...
3. **Business confirmation and release:** the dedicated Palm Desert phone (925-588-6546) was confirmed on September 13, 2026; edge-of-boundary coverage still needs confirmation. The user confirmed the public contact email as `murphsturfcare@gmail.com`; company data, visible contact links and legal pages now agree. The existing legal mailing address, `26323 Jefferson Avenue, Murrieta`, remains unconfirmed. The user has authorized release. Check live redirects, noindex headers on text mirrors, indexing, and lead delivery after deployment. The pre-release read-only check found the Palm Desert hub returning **404** on production and no Palm Desert entry in the live 215-URL sitemap. No messages or real leads were sent during local verification. GHL account setup is delegated to Claude in the [handoff](ghl-palm-desert-handoff.md).
